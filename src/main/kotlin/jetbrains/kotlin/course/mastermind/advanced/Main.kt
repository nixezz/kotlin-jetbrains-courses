...
fun isCorrectInput(userInput: String, wordLength: Int, alphabet: String): Boolean {
    ...
    if(userInput.any { it !in alphabet }){
        println("All symbols in your guess should be the ABCDEFGH alphabet characters! Try again!")
        return false
    }
    return true
}
...
fun safeUserInput(wordLength: Int, alphabet: String): String {
    var guess: String
    do {
        print("Please input your guess. It should be of length $wordLength, and each symbol should be from the alphabet: $alphabet.")
        guess = safeReadLine()
